...
<?php
    ...
    if (
        ...
        if (
            ...
            $eventsC->modifierevents($events, $_POST["id_ev"]);
                                                ...
                                                <div class="card">
                                                    ...
                                                    <?php
                                                        if (isset($_POST['id_ev'])){
                                                            $events = $eventsC->recupererevents($_POST['id_ev']);
				
		                                            ?>

                                                        <form action="" class="form-material" method="POST">
                                                            <div class="form-group form-default">
                                                                <input type="hidden" name="id_ev" id="id_ev"   value="<?php echo $events['id_ev']; ?>"  class="form-control" required="">
                                                                <span class="form-bar"></span>
                                                                <!-- <label class="float-label">Id_events</label> -->
                                                            </div>
                                                          
                                                            <div class="form-group form-default">
                                                                <input type="text"  id="nom_ev" name="nom_ev"  value="<?php echo $events['nom_ev']; ?>" class="form-control" required="" onblur="saisirNom()">
                                                                <span class="form-bar"></span>
                                                            ...
                                                            <div class="form-group form-default">
                                                                <input type="text"  id="lieu" name="lieu" class="form-control" value="<?php echo $events['lieu']; ?>" required="" onblur="saisirNom2()" >
                                                                <span class="form-bar"></span>
                                                            ...
                                                            <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                <textarea name="descrip_lieu" rows="5" cols="5" class="form-control" placeholder="Description lieu"><?php echo $events['descrip_lieu']; ?></textarea>
                                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group form-default">
                                                             <label class="col-sm-2 col-form-label">location place maps</label>
                                                                            <div class="col-sm-10">
                                                                                <textarea name="nb_p" rows="5" cols="5" class="form-control" placeholder="Location place maps <ifram>....."><?php echo $events['nb_p']; ?></textarea>
                                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                <textarea name="descrip_ev" rows="5" cols="5" class="form-control" placeholder="Description event....."><?php echo $events['descrip_ev']; ?></textarea>
                                                                            </div>
                                                            </div>

                                                            <div class="form-group form-default">
                                                                <input type="number"  id="spot" name="spot" class="form-control" required=""  onblur="spot()" value="<?php echo $events['spot']; ?>">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">spot</label>
