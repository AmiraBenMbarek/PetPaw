                                        ...
                                        <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <table id="product_table" border="1">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <button type="button" class="add_btn" onclick="updateProduct()">Update</button>
                                                                        </td>
                                                                        <td>
                                                                            <button type="button" class="add_btn" onclick="deleteProduct()">Delete</button>
                                                                        </td>
                                                                    </tr>
                                                                    <!--<tr>
                                                                        <td>
                                            ...
                                            <div class="form_popup" id="myform">
                                                <form action="" class="form_container">
                                                    ...
                                                    <input class="champs" onblur="saisirNom()" type="text" placeholder="Enter Name" id="name" required>
                                                    <p id="errorName" class="error"></p>

                                                    <input class="champs" onblur="saisirPrice()" type="number" placeholder="Enter Price" id="price" required>
                                                    <p id="errorPrice" class="error"></p>

                                                    <input class="champs" onblur="saisirQuantity()" type="number" placeholder="Enter Quantity" id="quantity" required>
                                                    <p id="errorQuantity" class="error"></p>

                                                    <input class="champs" onblur="saisirWeight()" type="number" placeholder="Enter Weight" id="weight" required>
                                                    <p id="errorWeight" class="error"></p>

                                                    <input type="file" name="image" id="image" required>

                                                    <textarea class="champs" onblur="saisirDescription()" placeholder="Enter Product Description" id="desc" required></textarea>
                                                    <p id="errorDescription" class="error"></p>

                                                    <button type="submit" onclick="ajoutproduit(event)" class="add_btn">Add</button>
                                                    <button type="button" class="add_btn" onclick="closeform()">Cancel</button>
                                                </form>
                                        </div>
                                        </div>
                                    </div>
