...
class productC
{
    ...
    function ajouterProduit($productM,$id){
        
        $sql="INSERT INTO product (ID_Pr, Name_Pr, Price_Pr, Quantity_Pr, Image_Pr, Description_Pr, Type_Pr, Category_Pr, id_admin )
			VALUES (NULL,:Name_Pr,:Price_Pr, :Quantity_Pr,:Image_Pr, :Description_Pr,:Type_Pr, :Category_Pr, $id)";
			$db = config::getConnexion();
			try{
