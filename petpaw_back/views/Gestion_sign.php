...
<?php include 'includes/header.php'; ?>
                                                ...
                                                <ul class="pcoded-submenu ">
                                                    ...
                                                    <li class="active">
                                                        <a href="" class="waves-effect waves-dark ">
                                                            <span class="pcoded-micon "><i class="ti-angle-right "></i></span>
                                                            <span class="pcoded-mtext " data-i18n="nav.basic-components.alert ">animals signal</span>
                                                            <span class="pcoded-mcaret "></span>
                                                        </a>
                                                    </li>
                                                </ul>
			...
			<tr>
				...
				<td><?php echo $crud['email_from']; ?></td>
				<td><?php echo $crud['email_from_alias']; ?></td>
				<td><?php echo $crud['objects']; ?></td>
                <td><?php echo $crud['body']; ?></td>
				<td><?php echo $crud['race']; ?></td>
				<td><?php echo $crud['endroit_recuperation']; ?></td>
                
				<td>
					<form method="POST" action="ajout_table_prin.php">
						<input type="submit" name="Modifier" value="ajouter à la table des animaux">
						<input type="hidden" value=<?PHP echo $crud['id']; ?> name="id">
					</form>
                    
				</td>
				<td>
                <a href="supprimercrud3.php?id=<?php echo $crud['id']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
