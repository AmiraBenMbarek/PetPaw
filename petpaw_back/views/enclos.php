...
<td> 
               <form method="POST" action="trier.php">
                     <input type="submit"  id="trier"  class="btn btn-primary btn-sm" value="trier DESC" ></input>
                     <input type="hidden" value=<?PHP echo  $pro['id']; ?> name="id">
               </form>
     ...
     <td> 
               <form method="POST" action="trier1.php">
                     <input type="submit"  id="trier1"  class="btn btn-primary btn-sm" value="trier ASC" ></input>
                     <input type="hidden" value=<?PHP echo  $pro['id']; ?> name="id">
               </form>
...
<ul class="pagination">
                        ...
                        <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
                            <a href="enclos.php?page=<?= $currentPage - 1 ?>" class="page-link">Précédente</a>
                        </li>
                        <?php 
                        for($page = 1; $page <= $pages; $page++): ?>
                          <!-- Lien vers chacune des pages (activé si on se trouve sur la page correspondante) -->
                          <li class="page-item <?= ($currentPage == $page) ? "active" : "" ?>">
                                <a href="enclos.php?page=<?= $page ?>" class="page-link"><?= $page ?></a>
                            </li>
                        <?php endfor ?>
                          <!-- Lien vers la page suivante (désactivé si on se trouve sur la dernière page) -->
                          <li class="page-item <?= ($currentPage == $pages) ? "disabled" : "" ?>">
                            <a href="enclos.php?page=<?= $currentPage + 1 ?>" class="page-link">Suivante</a>
                        </li>
                    </ul>
