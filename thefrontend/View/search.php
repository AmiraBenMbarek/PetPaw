...
try
{
 $bdd = new PDO('mysql:host=localhost;dbname=animaux_regimes', 'root', "");
				...
				while($terme_trouve = $select_terme->fetch()){
			                ?>
                                <article class="blog_item">
                                    ...
                                    <?php echo'<img src="thebackend/View/assets/images/'.$terme_trouve['img_animal'].'"width="750;" height="375" alt="image">' ?>
