<?php
	class gestion_animaux{
		...
		private $id_enclos=null;

		function __construct($id, $nom_Animal, $race, $genre,$poid,$date_recuperation,$endroit_recuperation,$idrg,$img_animal,$id_admin,$id_enclos){
            $this->id=$id;
		...
		function setid_enclos(string $id_enclos){
			$this->id_enclos=$id_enclos;
		}
