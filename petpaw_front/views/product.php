<?php
    ...
    $comment = $productC->afficherComments($id,$_SESSION["sessId"]["id"]);
                ...
                <div class="col-lg-5">
                    <div class="product__details__pic">
                        <div class="product__details__slider__content">
                            <img data-hash="product-1" src="assets3/img/gallery/<?php echo $product['Image_Pr']; ?>" height="360" width="270" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                            ...
                            <div class="comment_section p-5">
                                ...
                                <div class="commented-section mt-2">
                                    <div class="d-flex flex-row align-items-center commented-user">
                                        <h3 class="mr-2"><?php echo $cmt['nom'] ?></h3>
                                    </div>
                                    <div class="comment-text-sm"><span><?php echo $cmt['comment'] ?></span></div>
                                </div>
                                <?php } ?>
                            </div>
                    </div>
