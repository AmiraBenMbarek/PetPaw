...
if (isset($_GET["s"]) AND $_GET["s"] == "Rechercher")
{
 ...
 if (isset($terme))
 {
  ...
  $select_terme = $bdd->prepare("SELECT * FROM events WHERE nom_ev LIKE ? OR id_ev LIKE ? OR date_ev LIKE ?");
                                ...
                                <div class="page-body">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            ...
                                            <a href="gestion_events.php" > <input  class="btn btn-success btn-round waves-effect waves-light" type="submit" value="liste events"></a>
                                        </div>
                                    </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                 <thead>
                                                        ...
                                                        <tr>
                                                            <td>
                                                            <?php echo $terme_trouve['id_ev']; ?>
                                                             </td>
                                                            <td>
                                                            <?php echo $terme_trouve['nom_ev']; ?>
                                                            </td>
                                                            <td>
                                                            <?php echo $terme_trouve['lieu']; ?>
                                                            </td>
                                                            <td>
                                                            <?php echo $terme_trouve['descrip_lieu']; ?>
                                                            </td>
                                                            <td>
                                                            <?php echo $terme_trouve['date_ev']; ?>
                                                            </td>
                                                            <td>
                                                            <?php echo $terme_trouve['date_fin']; ?>
                                                            </td>
                                                            <td>
                                                            <?php echo $terme_trouve['nb_p']; ?>
                                                            </td>
                                                            <td>
                                                            <?php echo $terme_trouve['descrip_ev']; ?>
                                                            </td>
                                                            <td>
                                                            <?php echo $terme_trouve['spot']; ?>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <form method="POST" action="Modifier_events.php">
                                                                    ...
                                                                    <input type="hidden" value=<?PHP echo $terme_trouve['id_ev']; ?> name="id_ev">
                                                                </form>
                                                            </td>
                                                            <td>
                                                                <a  href="Supprimer_events.php?id_ev=<?php echo $terme_trouve['id_ev']; ?>">  <input class="btn btn-danger waves-effect waves-light" type="submit" value="Supprimer"></a>
                                                            </td>
